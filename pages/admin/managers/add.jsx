...
import {addManager} from "../../../store/manager/actions";
...
const Add = () => {
    ...
    const handleSubmit = (values) => {
        ...
        dispatch(addManager.request(formData));
        form.resetFields();
        setAvatarFile("")
        setAvatarPreview("")
    ...
    return (
        <App>
            ...
            <Form form={form} layout="vertical" onFinish={handleSubmit}>
                <Form.Item label="FullName" name="fullname" rules={[{required: true, message: 'Please enter the title'}]}>
